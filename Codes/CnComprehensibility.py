...
if __name__ == "__main__":
    ...
    sys.stdout = open('./Record/outputCnComprehensibility.txt', 'w')
    ...
    results_df.to_csv('RMSprop_test_results_cn_com.csv', index=False)

    test_mse = calculate_mse(net, test_loader, criterion)
    print(f'Mean Squared Error on Test Set: {test_mse}')

    PATH = './Models/RMSprop_ajusted_net_cn_com.pth'
    ...
    dot.render('./Models/RMSprop_network_graph_cn_compre', format='png')
