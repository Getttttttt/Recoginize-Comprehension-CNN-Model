...
if __name__ == "__main__":
    ...
    results_df.to_csv('RMSprop_test_results_en_in.csv', index=False)

    test_mse = calculate_mse(net, test_loader, criterion)
    print(f'Mean Squared Error on Test Set: {test_mse}')

    PATH = './Models/RMSprop_ajusted_net_en_in.pth'
    ...
    dot.render('./Models/RMSprop_network_graph_en_in', format='png')
